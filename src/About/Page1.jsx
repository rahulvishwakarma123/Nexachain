...
const Page1 = () => {
  return (
    <div className='bg-[#E1EBFF] px-30 flex items-center justify-center h-screen w-full bg-no-repeat bg-cover max-lg:block max-lg:h-auto max-lg:px-4 max-sm:pt-6'>
