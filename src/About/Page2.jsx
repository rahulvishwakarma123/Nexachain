...
const Page2 = () => {
  return (
    <div className='relative z-20 h-screen w-full flex justify-center gap-3 flex-col overflow-hidden max-lg:px-9 max-lg:h-[25vh] max-sm:h-[278px]'>
        <p className='z-20 text-4xl font-normal text-center text-white mb-10 max-sm:text-2xl'>Mission</p>
        <h1 className='z-20 text-8xl font-[Inter] font-black text-white text-center max-lg:text-5xl max-sm:text-4xl'>Connecting ideas to decentralized tech.</h1>
