...
const Footer = () => {
  return (
    <div className='w-full h-[446px] max-sm:h-auto'>
        <div className='h-[400px] bg-[#211F5E] text-white flex justify-center items-center px-32 max-lg:px-9 max-sm:h-auto max-sm:py-8 max-sm:px-4'>
            <div className="h-[228px] w-[1253px] flex justify-between">
                <div className='max-sm:mx-auto'>
                    <img className='mb-4 max-sm:mx-auto' src="images/nav-logo.svg" alt="navLogo" />
                    <p className='text-[20px] max-sm:text-center'>info@nexachain.in</p>
                    <p className='text-lg max-sm:text-center'>+91 12345 67890</p>
                    <div className='w-[204px] flex gap-4 justify-start mt-5 max-sm:justify-center'>
                ...
                <div className='basis-1/2 flex gap-28 items-start justify-end max-sm:hidden'>
        ...
        <div className='h-[46px] w-full flex items-center justify-center max-md:px-16 max-sm:my-1.5'>
            <p className='max-sm:text-sm max-sm:text-center'>@ Copyright 2025 Nexa Chain Core Pvt.Ltd. - All Rights Reserved.</p>
        </div>
    </div>
  )
}
